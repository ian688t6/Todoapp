...
//        }
    ...
    private void initTaskFragment() {
        TodolistFragment todoFragment = (TodolistFragment) getSupportFragmentManager().findFragmentById(R.id.contentFrame);
        if (todoFragment == null) {
            todoFragment = TodolistFragment.newInstance();
            ActivityUtils.addFragmentToActivity(getSupportFragmentManager(), todoFragment, R.id.contentFrame);
        }
        m_presenter = new TodolistPresenter(todoFragment);
    }
